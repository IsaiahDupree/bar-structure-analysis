"""
Create Clean Word Document for Problem Set 3 Solutions
This script generates a clean report that uses just the original problem images and titles simply as "Problem 1" and "Problem 2"
"""
import os
import docx
...
def create_clean_word_report():
    ...
    # Problem 1
    document.add_heading('Problem 1', level=1)
    
    # Part 1: Shape Functions
    document.add_heading('Shape Functions', level=2)
    ...
    document.add_heading('Displacements at ξ = 0.5', level=2)
    ...
    # Part 3: Strains
    document.add_heading('Strains at ξ = 0.5', level=2)
    ...
    document.add_heading('Stiffness Matrices', level=2)
    ...
    # Problem 2
    document.add_heading('Problem 2', level=1)
    ...
    document.add_paragraph('Problem 1:')
    ...
    # Problem 2 summary
    document.add_paragraph('Problem 2:')
    ...
    # Save the document
    document.save('Problem_Set_3_Clean.docx')
    print("Clean Word document created: Problem_Set_3_Clean.docx")

if __name__ == "__main__":
    create_clean_word_report()
